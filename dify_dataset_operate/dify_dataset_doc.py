...
if __name__ == "__main__":
    ...
    print(json.dumps(client.create_by_file("test.csv"), ensure_ascii=False, indent=2))

    # logging.info("update_by_file")
    # print(json.dumps(client.update_by_file("{document_id}", "test.csv"), ensure_ascii=False, indent=2))
